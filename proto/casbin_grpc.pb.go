...
type CasbinClient interface {
	...
	UpdateGroupingPolicy(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*BoolReply, error)
...
func (c *casbinClient) UpdateGroupingPolicy(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*BoolReply, error) {
	out := new(BoolReply)
	err := c.cc.Invoke(ctx, "/proto.Casbin/UpdateGroupingPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CasbinServer interface {
	...
	UpdateGroupingPolicy(context.Context, *UpdateRequest) (*BoolReply, error)
...
func (UnimplementedCasbinServer) UpdateGroupingPolicy(context.Context, *UpdateRequest) (*BoolReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateGroupingPolicy not implemented")
}
...
func _Casbin_UpdateGroupingPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CasbinServer).UpdateGroupingPolicy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Casbin/UpdateGroupingPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CasbinServer).UpdateGroupingPolicy(ctx, req.(*UpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Casbin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateGroupingPolicy",
			Handler:    _Casbin_UpdateGroupingPolicy_Handler,
		},
		{
